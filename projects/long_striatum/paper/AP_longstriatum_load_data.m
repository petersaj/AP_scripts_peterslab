...
switch load_dataset
    case 'task'
        ...
        striatum_move_mua_sum = cellfun(@(mua,mua_group) ap.groupfun(@sum,mua,[],[],mua_group), ...
            ephys.binned_msn_spikes_move_align,kidx_rec,'uni',false);
        striatum_move_mua = cell2mat(cellfun(spikes_norm_smooth_reshape_fcn, ...
            striatum_move_mua_sum,mua_baseline,'uni',false));

        % Create move-aligned MUA
        striatum_outcome_mua_sum = cellfun(@(mua,mua_group) ap.groupfun(@sum,mua,[],[],mua_group), ...
            ephys.binned_msn_spikes_outcome_align,kidx_rec,'uni',false);
        striatum_outcome_mua = cell2mat(cellfun(spikes_norm_smooth_reshape_fcn, ...
            striatum_outcome_mua_sum,mua_baseline,'uni',false));
