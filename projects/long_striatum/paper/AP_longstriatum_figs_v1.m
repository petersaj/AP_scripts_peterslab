...
striatum_activity_max = mean(striatum_activity_mean(:,isbetween(psth_t,stim_t(1),stim_t(2))),2);
...
cortex_activity_max = permute(mean(cortex_activity_mean(:,isbetween(wf_t,stim_t(1),stim_t(2)),:),2),[1,3,2]);
