...
for curr_shank = 1:n_shanks
    ...
    set(gca,'YDir','reverse'); % ~~~ TEMPORARY? for current dist from surface convention
    ...
    for curr_area = curr_shank_areas'
        ...
        curr_y = shank_size-probe_areas{1}.tip_distance(curr_area,:); % ~~~ TEMPORARY? to match template_depths
    ...
    % Label area centers
    curr_area_centers = shank_size-mean(probe_areas{1}.tip_distance(curr_shank_areas,:),2);
