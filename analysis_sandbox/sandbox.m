...
scatter3(template_ccf(:,1),template_ccf(:,3),template_ccf(:,2),10*max(event_spikes_meandiff{2},0)+1,'b','filled','MarkerFaceAlpha',0.5);
scatter3(template_ccf(:,1),template_ccf(:,3),template_ccf(:,2),10*max(event_spikes_meandiff{3},0)+1,'r','filled','MarkerFaceAlpha',0.5);
