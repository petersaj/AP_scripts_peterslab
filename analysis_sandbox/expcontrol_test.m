...
connection_modalities = {'Timelite','Stim','Mousecam','Widefield','Ephys'};
connection_ports = [ ...
...
handles.mouse = uieditfield(rec_settings_panel_grid);
handles.protocol = ...
...
handles.connection_lamps([gui_data.connection_tcpservers.Connected]).Color = 'g';
handles.connection_lamps(~[gui_data.connection_tcpservers.Connected]).Color = 'r';
end



%%%%%%%%%%% UNDER CONSTRUCTION
function read_incoming(server_stim, ~, server_timelite, server_mousecam, server_widefield, StartButton)
