function h = draw_wf_ccf(type,color,reference_im,repeats)
% h = draw_wf_ccf(type,color,reference_im,repeats)
%
...
% (cortical regions)
load(fullfile(alignment_path,'cortical_area_boundaries.mat'));
